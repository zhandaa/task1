   	...
   	<div class="intro-content">
   		<div class="row">
   			...
   			<div class="col-twelve">
	   			...
	   			<h5>Hello, World.</h5>
	   			<h1>I'm Fedotov Daniil.</h1>

	   			<p class="intro-position">
	   				<span>Front-end Developer</span>
	   				<span>EKTU Student</span> 
	   			</p>
   		...
   		<div class="col-six tab-full">
   			...
   			<ul class="info-list">
   				<li>
   					...
   					<span>Fedotov Daniil</span>
   				</li>
   				<li>
   					<strong>Birth Date:</strong>
   					<span>December 24, 2003</span>
   				</li>
   				<li>
   					<strong>Job:</strong>
   					<span>Homeless, Frontend Developer</span>
   				</li>
   				<li>
   					<strong>Website:</strong>
   					<span>www.fridaythirteeen.com</span>
   				</li>
   				<li>
   					<strong>Email:</strong>
   					<span>fridaythirteeen@gmail.com</span>
   				</li>
   		...
   		<div class="col-twelve">
   			...
   			<div class="timeline-wrap">
	   			...
	   			<div class="timeline-block">
	   				...
	   				<div class="timeline-header">
	   					<h3>Web Student</h3>
	   					<p>May 1003 - June 1004</p>
	   				</div>

	   				<div class="timeline-content">
	   					<h4>Great Student Studio</h4>
	   					<p>Lorem ipsum Occaecat do esse ex et dolor culpa nisi ex in magna consectetur nisi cupidatat laboris esse eiusmod deserunt aute do quis velit esse sed Ut proident cupidatat nulla esse cillum laborum occaecat nostrud sit dolor incididunt amet est occaecat nisi incididunt.</p>
	   				</div>
   ...
   ================================================== -->
	<section id="contact">
   	...
   	<div class="row contact-form">
   		<div class="col-twelve">
<form name="contactForm" id="contactForm" method="post" action="process_form.php" class="contact-form" method="POST" type="Submit">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="contactName" class="form-label">Name</label>
                    <input name="contactName" type="text" id="contactName" class="form-control" placeholder="Name" value="" minlength="2" required="">
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="contactEmail" class="form-label">Email</label>
                    <input name="contactEmail" type="email" id="contactEmail" class="form-control" placeholder="Email" value="" required="">
                </div>
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <input name="contactSubject" type="text" id="contactSubject" class="form-control" placeholder="Subject" value="">
        </div>

        <div class="mb-3">
            <label for="contactMessage" class="form-label">Message</label>
            <textarea name="contactMessage" id="contactMessage" class="form-control" placeholder="Message" rows="5" required=""></textarea>
        </div>
     	...
     	<div class="row">
      	...
      	<div class="col-six tab-full">
	      	<div class="copyright">
		        	...
		        	<span>Design by <a href="http://kencarson.xyz/">fridaythirteeen</a></span>	         	
		         </div>		                  
	      	</div>
	      	<div id="go-top">
